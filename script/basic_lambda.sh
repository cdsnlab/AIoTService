...
# lambda_list="0.1 0.01 0.001 0.0001 0.00001 0"
lambda_list="0"
file_name="basic_lambda_1002"
device="3"
random_noise="True"
n_fold_cv="True"
dropout_rate="0.5"
...
do
    echo "lambda: $i"
    python train.py --nepochs $nepochs --lam $i --exp_info_file $file_name --device $device --random_noise $random_noise --n_fold_cv $n_fold_cv --with_other $with_other --model $model --train_attn $train_attn --dropout_rate $dropout_rate --except_all_other_events $except_all_other_events --utilize_tr $utilize_tr --dataset $dataset
done
