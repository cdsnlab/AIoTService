...
# lam="0.001"
file_name="noise_basic_entropy_0920_01"
device="3"
random_noise="True"
n_fold_cv="True"
with_other="False"
model="EARLIEST"
entropy_halting="True"


for i in $lambda_list
do
    echo "lambda: $i"
    python train.py --lam $i --exp_info_file $file_name --device $device --random_noise $random_noise --n_fold_cv $n_fold_cv --with_other $with_other --model $model --entropy_halting $entropy_halting
done
