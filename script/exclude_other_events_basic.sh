...
# lambda_list="0.00001"
file_name="exc_other_basic_0922"
device="1"
random_noise="True"
n_fold_cv="True"
dropout_rate="0.5"
...
do
    echo "lambda: $i"
    python train.py --lam $i --exp_info_file $file_name --device $device --random_noise $random_noise --n_fold_cv $n_fold_cv --with_other $with_other --model $model --train_attn $train_attn --dropout_rate $dropout_rate --except_all_other_events $except_all_other_events
done
